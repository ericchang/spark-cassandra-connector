...
private[connector] class CassandraRunner(val configTemplate: String, props: Map[String, String], release: => Unit)
  ...
  System.out.println(s"--------======== Starting Embedded Cassandra at ${props.get("native_transport_port").get} ========--------")
...
//      sunJmxProperty, sunJmxPortProperty, sunJmxAuthProperty, sunJmxRmiPortProperty,
